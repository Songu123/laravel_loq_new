...
@section('title', 'Đăng ký Admin - LOQ')
@section('auth-title', 'Đăng ký Admin')
@section('auth-subtitle', 'Tạo tài khoản quản trị viên cho hệ thống LOQ')

@section('auth-content')
<form method="POST" action="{{ route('register.admin.post') }}" class="auth-form">
    @csrf
    ...
    <button type="submit" class="btn btn-primary btn-auth">
        <i class="bi bi-person-plus me-2"></i>Đăng ký Admin
    </button>
</form>
...
<div class="auth-links">
    ...
    <div class="d-flex gap-2 flex-wrap justify-content-center">
        <a href="{{ route('login.admin') }}" class="btn btn-outline-primary btn-sm">
            <i class="bi bi-box-arrow-in-right me-1"></i>Đăng nhập Admin
        </a>
        <a href="{{ route('login.teacher') }}" class="btn btn-outline-success btn-sm">
            <i class="bi bi-mortarboard me-1"></i>Đăng nhập Teacher
        </a>
