...
@section('auth-title', 'Đăng nhập - Sinh viên')
@section('auth-subtitle', 'Đăng nhập để tham gia các bài thi và xem kết quả của bạn')

@section('form-title', 'Đăng nhập Sinh viên')
...
<div class="text-center">
    <p class="mb-2">
        ...
        <a href="{{ route('register.student') }}" class="fw-semibold">Đăng ký ngay</a>
    </p>
    <p class="mb-0">
        <a href="{{ route('login.teacher') }}" class="text-decoration-none">
            <i class="bi bi-person-workspace me-1"></i>Đăng nhập với tư cách Giáo viên
        </a>
    </p>
</div>
@endsection
