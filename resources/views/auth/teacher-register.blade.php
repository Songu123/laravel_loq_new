...
@section('auth-subtitle', 'Tạo tài khoản để quản lý đề thi và theo dõi kết quả học sinh')

@section('form-title', 'Đăng ký Giáo viên')
...
<div class="text-center">
    <p class="mb-2">
        Đã có tài khoản? 
        <a href="{{ route('login.teacher') }}" class="fw-semibold">Đăng nhập</a>
    </p>
    <p class="mb-0">
        <a href="{{ route('register.student') }}" class="text-decoration-none">
            <i class="bi bi-person-circle me-1"></i>Đăng ký với tư cách Sinh viên
        </a>
    </p>
</div>
@endsection
