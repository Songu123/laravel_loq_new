...
@section('title', 'Đăng ký Học sinh - LOQ')
@section('auth-title', 'Đăng ký Học sinh')
@section('auth-subtitle', 'Tạo tài khoản học sinh cho hệ thống LOQ')
...
<form method="POST" action="{{ route('register.student.post') }}" class="auth-form">
    ...
    <div class="form-group">
        <label for="student_id" class="form-label">
            <i class="bi bi-card-text me-2"></i>Mã học sinh
        </label>
        <input type="text" 
    ...
    <button type="submit" class="btn btn-info btn-auth">
        <i class="bi bi-person-plus me-2"></i>Đăng ký Học sinh
    </button>
</form>
...
<div class="auth-links">
    ...
    <div class="d-flex gap-2 flex-wrap justify-content-center">
        ...
        <a href="{{ route('login.student') }}" class="btn btn-outline-info btn-sm">
            <i class="bi bi-box-arrow-in-right me-1"></i>Đăng nhập Student
        </a>
    </div>
</div>
